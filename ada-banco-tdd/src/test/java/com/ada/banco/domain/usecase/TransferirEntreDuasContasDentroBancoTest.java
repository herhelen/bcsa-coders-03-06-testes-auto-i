...
public class TransferirEntreDuasContasDentroBancoTest {
    ...
    @Test
    public void naoDeveFazerTransferenciaSemSaldoSuficiente() throws Exception {
        // given
        Conta origem = new Conta(1111L, 2222L, 1L, BigDecimal.valueOf(1000.0),
                "Origem", "11122233344");
        Conta destino = new Conta(4444L, 5555L, 4L, BigDecimal.ZERO,
        ...
        // when & then
        Conta origemPosTransferencia =
                transferirEntreContasDentroBanco.execute(origem, destino, BigDecimal.valueOf(2000.0));

        assertAll(
                () -> assertEquals(BigDecimal.valueOf(1000.0), origemPosTransferencia.getSaldo()),
