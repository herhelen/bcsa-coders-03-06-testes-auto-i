...
public class CarroTestNew {
    ...
    public void deveIniciarDelsigado() {
        ...
        Assertions.assertFalse(carro.getLigado()); // valor esperado: false
    }
    ...
    public void deveIniciarComVelocidadeZero() {
        ...
        Assertions.assertEquals((Integer) 0, carro.getVelocidadeAtual()); // valor esperado: 0
    }
    ...
    public void deveLigarCorretamente() {
        ...
        Assertions.assertTrue(carro.getLigado()); // valor esperado: true
    }
    ...
    public void deveAcelerarCorretamente() {
        ...
        Assertions.assertEquals((Integer) 20, carro.getVelocidadeAtual()); // valor esperado: 20
    }
